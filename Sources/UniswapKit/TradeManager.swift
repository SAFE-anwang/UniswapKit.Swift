...
class TradeManager {
    ...
    init(evmKit: EvmKit.Kit, address: Address, isSafeSwap: Bool = false) throws {
        routerAddress = try Self.routerAddress(chain: evmKit.chain, isSafeSwap:isSafeSwap)
...
extension TradeManager {
    ...
    private static func initCodeHashString(chain: Chain, isSafeSwap: Bool) throws -> String {
        if isSafeSwap {
            switch chain {
            case .ethereum, .ethereumGoerli, .polygon, .avalanche: return "0xad0e51aa7a058efb9eb40fd6385473f0175ee7419e8d4f91a4e0294ec12b2d13"
